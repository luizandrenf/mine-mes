...
public sealed class ProductionOrderConfiguration : IEntityTypeConfiguration<ProductionOrder>
{
    public void Configure(EntityTypeBuilder<ProductionOrder> builder)
    {
        ...
        // FK to products, no navigation property. Restrict: block deleting a product that has orders.
        builder
            .HasOne<Product>()
            .WithMany()
        ...
        // Store the enum as text ("Draft", "Released"...) instead of an int: readable and reorder-proof.
        builder
