...
namespace MiniMes.Production.Data.Migrations
{
    ...
    [Migration("20260808185849_AddProductionOperation")]
    partial class AddProductionOperation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniMes.Production.Domain.Entities.ProductionOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MiniMes.Production.Domain.Entities.ProductionOperation", b =>
                {
                    b.HasOne("MiniMes.Production.Domain.Entities.ProductionOrder", null)
                        .WithMany("Operations")
